...
const variants: Record<Variant, string> = {
  primary:
    'bg-accent text-accent-fg shadow-[0_3px_0_rgb(var(--keycap)_/_0.28)] hover:brightness-105 active:translate-y-[3px] active:shadow-none disabled:hover:brightness-100',
  surface:
    'bg-surface-2 text-fg border border-line/60 shadow-[0_3px_0_rgb(var(--keycap)_/_0.22)] hover:brightness-105 active:translate-y-[3px] active:shadow-none',
  ghost: 'text-muted hover:text-fg hover:bg-surface-2',
  card:
    '!block border border-line/40 bg-surface text-fg shadow-lg shadow-[color:rgb(var(--card-shadow)_/_0.15)] hover:-translate-y-1 hover:shadow-xl hover:shadow-[color:rgb(var(--card-shadow)_/_0.25)]',
...
export function IconButton({
  ...
  return (
    <button
      ...
      className={`inline-flex h-8 w-8 items-center justify-center rounded-lg border border-line/50 bg-surface-2 shadow-[0_2px_0_rgb(var(--keycap)_/_0.2)] transition-all duration-100 hover:brightness-105 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-bg active:translate-y-[2px] active:shadow-none ${
